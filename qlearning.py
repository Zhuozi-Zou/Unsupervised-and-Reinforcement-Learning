...
def qlearn(env, num_iters, alpha, gamma, epsilon, max_steps, use_softmax_policy, init_beta=None, k_exp_sched=None):
    ...
    Returns:
        q_hat: A Q-value table shaped [num_states, num_actions] for environment with num_states
    ...
    for i in range(num_iters):
        ...
        while not done and num_steps < max_steps:
            ...
            if next_state != curr_state:
                new_value = reward + gamma * max(q_hat[next_state]) - q_hat[curr_state, action]
